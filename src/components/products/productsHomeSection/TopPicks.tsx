...
//----------------------------------- Database and redux store both working but issue is not optimal for multiple users userId//
import {
	Badge,
	Box,
	Button,
...
import {
	...
	removeFromWishlist,
	wishlistSelectors,
} from '../../../redux/wishlistSliceRedux/wishlistSlice';
import {
	useAddToWishlistMutation,
...
const TopPicks = () => {
	...
	useEffect(() => {
		const items = Object.values(wishlistState) as ProductFormValues[];
		setWishlistItems(items);
	}, [wishlistState]);

	const toggleWishlistMutation = useAddToWishlistMutation();
	const [mutateToggleWishlist] = toggleWishlistMutation;
	...
	useEffect(() => {
		const items = Object.values(wishlistState) as ProductFormValues[];
		setWishlistItems(items);
	}, [wishlistState, toggleWishlistMutation]);
